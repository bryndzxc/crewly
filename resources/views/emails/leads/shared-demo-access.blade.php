                    ...
                    <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="max-width: 640px; background-color: #ffffff; border: 1px solid #e2e8f0; border-radius: 12px; overflow: hidden;">
                        <tr>
                            <td style="background-color: #2563eb; padding: 18px 24px;">
                                ...
                                <div style="margin-top: 6px; font-size: 20px; font-weight: 700; line-height: 1.25; color: #ffffff;">Live demo access</div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td style="padding: 24px;">
                                ...
                                <p style="margin: 0 0 16px 0;">
                                    Here are the credentials for Crewly’s shared live demo environment.
                                </p>
                                ...
                                <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse; border: 1px solid #e2e8f0; border-radius: 10px; overflow: hidden;">
                                    ...
                                    <tr>
                                        <td style="padding: 10px 14px; width: 180px; background-color: #f8fafc; color: #475569;">Password</td>
                                        <td style="padding: 10px 14px; font-weight: 600;">{{ $password }}</td>
                                    </tr>
                                </table>
                                ...
                                <p style="margin: 16px 0 0 0; color: #475569; font-size: 12px;">
                                    Note: This is a shared demo environment and may reset periodically.
                                </p>
