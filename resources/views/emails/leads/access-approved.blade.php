                    ...
                    <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="max-width: 640px; background-color: #ffffff; border: 1px solid #e2e8f0; border-radius: 12px; overflow: hidden;">
                        <tr>
                            <td style="background-color: #2563eb; padding: 18px 24px;">
                                ...
                                <div style="margin-top: 6px; font-size: 20px; font-weight: 700; line-height: 1.25; color: #ffffff;">Your account is ready</div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td style="padding: 24px;">
                                ...
                                <p style="margin: 0 0 16px 0;">Your Crewly access request has been approved. We’ve created your company and login details below.</p>
                                ...
                                <p style="margin: 16px 0 0 0; color: #475569;">For security, you’ll be asked to change your password on first login.</p>

                                <hr style="border: none; border-top: 1px solid #e2e8f0; margin: 20px 0;" />

                                <p style="margin: 0; color: #64748b; font-size: 12px;">If you didn’t request access to Crewly, you can ignore this email.</p>
                            </td>
                        </tr>
                    </table>
                </td>
