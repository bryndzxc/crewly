                    ...
                    <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="max-width: 640px; background-color: #ffffff; border: 1px solid #e2e8f0; border-radius: 12px; overflow: hidden;">
                        <tr>
                            <td style="background-color: #2563eb; padding: 18px 24px;">
                                ...
                                <div style="margin-top: 6px; font-size: 20px; font-weight: 700; line-height: 1.25; color: #ffffff;">Welcome to Crewly</div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td style="padding: 24px;">
                                ...
                                <div style="margin-top: 16px;">
                                    <a href="{{ $loginUrl }}" style="display: inline-block; background-color: #2563eb; color: #ffffff; text-decoration: none; padding: 12px 16px; border-radius: 8px; font-weight: 600;">Sign in to Crewly</a>
                                </div>
