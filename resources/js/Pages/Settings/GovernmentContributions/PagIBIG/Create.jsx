...
export default function Create({ auth }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        form.post(route('settings.government_contributions.pagibig.store'));
    };

    return (
        <AuthenticatedLayout user={auth.user} header="Settings" contentClassName="max-w-4xl mx-auto">
            <Head title="Add Pag-IBIG Setting" />
            ...
            <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                    <div>
                        <div className="text-lg font-semibold text-slate-900">Add Pag-IBIG setting</div>
                        <div className="text-sm text-slate-600">Defines threshold, employee/employer rates, and a monthly cap.</div>
                    </div>
