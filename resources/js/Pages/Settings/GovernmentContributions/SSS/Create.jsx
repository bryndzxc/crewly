        ...
        <AuthenticatedLayout user={auth.user} header="Settings" contentClassName="max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                    <div>
                        <div className="text-lg font-semibold text-slate-900">Add SSS contribution rule</div>
                        <div className="text-sm text-slate-600">Creates a DB-driven range entry for the effectivity period.</div>
                    </div>
