...
export default function Create({ auth }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        form.post(route('settings.government_contributions.philhealth.store'));
    };

    return (
        <AuthenticatedLayout user={auth.user} header="Settings" contentClassName="max-w-4xl mx-auto">
            <Head title="Add PhilHealth Setting" />
            ...
            <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                    <div>
                        <div className="text-lg font-semibold text-slate-900">Add PhilHealth setting</div>
                        <div className="text-sm text-slate-600">Defines premium rate, salary clamp, and split percentages.</div>
                    </div>
