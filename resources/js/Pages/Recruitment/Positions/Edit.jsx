...
export default function Edit({ auth, position, inModal = false, onCancel, onSuccess }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        patch(route('recruitment.positions.update', position.id), {
            preserveScroll: true,
    ...
    return (
        <AuthenticatedLayout user={auth.user} header="Edit Position">
