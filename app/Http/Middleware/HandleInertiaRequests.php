    ...
    public function share(Request $request): array
    {
        ...
        return [
            ...
            'can' => [
                ...
                'generatePayroll' => $user ? Gate::forUser($user)->check('generate-payroll') : false,
                'editPayrollDeductions' => $user ? Gate::forUser($user)->check('edit-payroll-deductions') : false,
                'reviewPayroll' => $user ? Gate::forUser($user)->check('review-payroll') : false,
                'finalizePayroll' => $user ? Gate::forUser($user)->check('finalize-payroll') : false,
                'releasePayroll' => $user ? Gate::forUser($user)->check('release-payroll') : false,
